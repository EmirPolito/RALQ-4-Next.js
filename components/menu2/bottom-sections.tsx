...
import { ChevronDown, ChevronRight, BookOpen, BarChart2 } from "lucide-react";
...
export function BottomSections({ data, compareLabel = "INSTRUMENTOS" }: BottomSectionsProps) {
        ...
        <div className="flex gap-3 flex-1 min-h-0">
          {galleryCards.map((card) => (
            <motion.button
              ...
              className={cn(
                "flex-1 flex flex-col rounded-xl overflow-hidden border transition-all cursor-pointer",
