    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 md:px-5 py-35 text-left">
        ...
        <div className="space-y-6 text-base text-descripciones leading-relaxed">
          ...
          <p>
            En <strong className="text-titulos">RALQ</strong> {t("intro")}
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong className="text-titulos">{t("s1l1Label")}</strong> {t("s1l1")}
            </li>
            <li>
              <strong className="text-titulos">{t("s1l2Label")}</strong> {t("s1l2")}
            </li>
            <li>
              <strong className="text-titulos">{t("s1l3Label")}</strong> {t("s1l3")}
            </li>
          </ul>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong className="text-titulos">{t("s3l1Label")}</strong> {t("s3l1")}
            </li>
            <li>
              <strong className="text-titulos">{t("s3l2Label")}</strong> {t("s3l2")}
            </li>
            <li>{t("s3l3")}</li>
          </ul>
